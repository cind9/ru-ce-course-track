...
const eeUpperDivision: Course[] = [
  ...
  {
    id: "ee-restricted-elective",
    label: "Restricted Electrical",
    title: "Restricted Electrical Elective (see dept list)",
    credits: 3,
    residencyCredits: 3,
    category: "elective",
    year: 3,
    ...
    prereqs: [],
    offered: "both",
    note: "Junior fall · pick from electrical elective list",
  },
  {
    id: "hss-2a",
    label: "200 or above",
